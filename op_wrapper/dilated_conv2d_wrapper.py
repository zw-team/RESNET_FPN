...
class DilatedConvolutionFunction(Function):
    ...
    def backward(ctx, *grad_outputs):
        ...
        grad_input, grad_weight, grad_bias, out_grad = dilated_conv2d.backward(input, weights, bias, grad_copy, ctx.stride_h, ctx.stride_w, ctx.dilation_h, ctx.dilation_w)
